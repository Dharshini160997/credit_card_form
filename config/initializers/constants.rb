TERM_IN_MONTHS = {"first" => 6,"second"=>12,"third"=>18,"fourth"=>24}
FULL_CONTACT_API = "https://api.fullcontact.com/v2/person.json?email"
API_KEY = "uA6TuVzTHWADhBuZYaRND38YTsLgFihx"
MOCKED_RESPONSE = {
  "status" => 200,
